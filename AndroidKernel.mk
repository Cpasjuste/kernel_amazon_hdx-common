...
$(KERNEL_CONFIG): $(KERNEL_OUT)
	$(MAKE) -C $(KERNEL_PATH) O=$(KERNEL_OUT_ABS) ARCH=arm CROSS_COMPILE=arm-eabi- $(KERNEL_DEFCONFIG)
	if [ "$(USE_TRAPZ)" = "true" ]; then cat $(KERNEL_PATH)/arch/arm/configs/trapz.config >> $@ ;\
	$(MAKE) -C $(KERNEL_PATH) O=$(KERNEL_OUT_ABS) ARCH=arm CROSS_COMPILE=arm-eabi- oldconfig; fi
