/*
 * lab126_cci_sysfs.c
 * sysfs node to do CCI read and write (Only root user access)
 *
...
//struct msm_camera_i2c_reg_setting write_conf;
struct msm_camera_i2c_reg_array write_conf;
		  ...
		  enum msm_camera_i2c_data_type data_type)
{
	...
	cci_ctrl.cfg.cci_i2c_write_cfg.reg_setting = &write_conf;
