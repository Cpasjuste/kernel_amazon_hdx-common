...
static int mdss_fb_register(struct msm_fb_data_type *mfd)
{
	...
	/* Note required portrait->landscape swap for apollo - reversing
	 * height and width will not produce correct results unless the
	 * framebuffers themselves are also rotated!
	 */
	...
	var->width = 94,	/* width of picture in mm */
#else
