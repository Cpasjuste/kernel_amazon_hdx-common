...
static int qca1530_suspend(struct device *dev)
{
...
static int qca1530_resume(struct device *dev)
{
	struct platform_device *pdev = to_platform_device(dev);

	return qca1530_pwr_init(pdev);
}

static SIMPLE_DEV_PM_OPS(qca1530_pm_ops, qca1530_suspend, qca1530_resume);
#endif
