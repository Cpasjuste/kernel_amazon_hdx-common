		...
		struct cyttsp5_touch *tch, int num_cur_tch)
{
	...
	for (i = 0; i < num_cur_tch; i++) {
		...
		/*
		 * This is for Android version < 4.0, not required for newer
		 * versions but kept to support older Android versions.
		 * In Android version < 4.0, ABS_MT_TOUCH_MAJOR is used as
		 * ABS_MT_PRESSURE.
		 */
