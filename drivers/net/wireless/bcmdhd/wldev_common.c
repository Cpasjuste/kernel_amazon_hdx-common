...
#define LAB126_CODE_US		"US"
#define LAB126_CODE_CANADA	"CN"
#define LAB126_CCODE_US		"Q1"
#define LAB126_REVISION_US 	109
#define LAB126_CCODE_ROW 	"XZ"
#define LAB126_REVISION_ROW 	42
#endif
...
#ifdef LAB126_FEATURE_SUPPORT
		if (!strncmp(country_code, LAB126_CODE_US, 2)
			|| !strncmp(country_code, LAB126_CODE_CANADA, 2))
		{
			cspec.rev = LAB126_REVISION_US;
			memcpy(cspec.ccode, LAB126_CCODE_US, WLC_CNTRY_BUF_SZ);
		}
		else
		{
			cspec.rev = LAB126_REVISION_ROW;
			memcpy(cspec.ccode, LAB126_CCODE_ROW , WLC_CNTRY_BUF_SZ);
		}
#else
