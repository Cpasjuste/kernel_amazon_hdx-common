 ...
 * Modified by SanDisk Corp., Copyright ?? 2014 SanDisk Corp.
 *
...
/*
 * Dummmy Read Sequence
 */
static int mmc_dummy_read_sequence(struct mmc_card *card, struct mmc_blk_data *md)
{
	...
	struct mmc_ioc_rpmb __user *ic_ptr)
{
	...
	for (i = 0; i < MMC_IOC_MAX_RPMB_CMD; i++) {
        ...
        /* Some eMMC cards requires RPMB issue workaround */
...
static const struct mmc_fixup blk_fixups[] =
{
	...
	/*
	 *  Some devices have RPMB issue and requires Workaround
	 */
