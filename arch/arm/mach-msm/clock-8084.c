...
#if defined(CONFIG_ARCH_APQ8084_LOKI) || defined(CONFIG_ARCH_APQ8084_SATURN)
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "6c.qcom,camera"), //RFC
	CLK_LOOKUP("cam_src_clk", mclk2_clk_src.c, "20.qcom,camera"), //FFC
	CLK_LOOKUP("cam_src_clk", mclk0_clk_src.c, "a0.qcom,eeprom"),
...
#if defined(CONFIG_ARCH_APQ8084_LOKI) || defined(CONFIG_ARCH_APQ8084_SATURN)
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "6c.qcom,camera"), //RFC
	CLK_LOOKUP("cam_clk", camss_mclk2_clk.c, "20.qcom,camera"), //FFC
	CLK_LOOKUP("cam_clk", camss_mclk0_clk.c, "a0.qcom,eeprom"),
