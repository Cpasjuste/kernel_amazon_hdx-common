...
extern struct rcg_clk audio_core_lpaif_sec_clk_src;
extern struct branch_clk audio_core_lpaif_sec_osr_clk;
extern struct branch_clk audio_core_lpaif_sec_ebit_clk;
extern struct branch_clk audio_core_lpaif_sec_ibit_clk;
extern struct pll_vote_clk lpapll0_clk_src;
#endif
...
#if defined(CONFIG_MACH_URSA)
	CLK_LOOKUP("core_clk", audio_core_lpaif_sec_clk_src.c, "msm-dai-q6-mi2s.1"),
	CLK_LOOKUP("osr_clk", audio_core_lpaif_sec_osr_clk.c, "msm-dai-q6-mi2s.1"),
	CLK_LOOKUP("ebit_clk", audio_core_lpaif_sec_ebit_clk.c, "msm-dai-q6-mi2s.1"),
	CLK_LOOKUP("ibit_clk", audio_core_lpaif_sec_ibit_clk.c, "msm-dai-q6-mi2s.1"),
#endif
};
...
#if defined(CONFIG_MACH_URSA)
	audio_core_lpaif_sec_clk_src.base = &virt_bases[LPASS_BASE];
	audio_core_lpaif_sec_osr_clk.base = &virt_bases[LPASS_BASE];
	audio_core_lpaif_sec_ebit_clk.base = &virt_bases[LPASS_BASE];
	audio_core_lpaif_sec_ibit_clk.base = &virt_bases[LPASS_BASE];
	lpapll0_clk_src.base = &virt_bases[LPASS_BASE];
#endif
