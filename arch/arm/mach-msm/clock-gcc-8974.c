...
struct pll_vote_clk lpapll0_clk_src = {
...
struct rcg_clk audio_core_lpaif_sec_clk_src = {
...
struct branch_clk audio_core_lpaif_sec_osr_clk = {
...
struct branch_clk audio_core_lpaif_sec_ebit_clk = {
...
struct branch_clk audio_core_lpaif_sec_ibit_clk = {
...
static struct clk_lookup msm_clocks_gcc_8974[] = {
	...
	CLK_LOOKUP_OF("core_clk", gcc_blsp1_uart6_apps_clk, ""),
        ...
        CLK_LOOKUP_OF("iface_clk", gcc_blsp2_ahb_clk, "f9968000.i2c"),
#endif
#if defined(CONFIG_MACH_URSA)
...
#if defined(CONFIG_ARCH_MSM8974_APOLLO) || defined(CONFIG_ARCH_MSM8974_THOR)
        CLK_LOOKUP_OF("core_clk", gcc_blsp2_qup6_i2c_apps_clk, "f9968000.i2c"),
#endif
#if defined(CONFIG_MACH_URSA)
...
#if defined(CONFIG_ARCH_MSM8974_APOLLO) || defined(CONFIG_ARCH_MSM8974_THOR)
	CLK_LOOKUP_OF("cam_src_clk", gp1_clk_src, "20.qcom,camera"), // Front camera
	CLK_LOOKUP_OF("cam_clk", gcc_gp1_clk, "20.qcom,camera"),
#else
#if !defined(CONFIG_MACH_URSA)
