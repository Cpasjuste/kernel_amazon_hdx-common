...
static struct clk_lookup msm_camera_clocks_8974_only[] = {
	...
	CLK_LOOKUP_OF("cam_src_clk", mmss_gp0_clk_src, "6c.qcom,camera"),  // Back camera
	CLK_LOOKUP_OF("cam_clk", camss_gp0_clk, "6c.qcom,camera"),
#else
	CLK_LOOKUP_OF("cam_src_clk", mmss_gp0_clk_src, "6e.qcom,camera"), //RFC URSA
	...
	CLK_LOOKUP_OF("cam_clk", camss_gp0_clk, "20.qcom,camera"),//RFC URSA
	...
	CLK_LOOKUP_OF("cam_src_clk", mmss_gp0_clk_src, "6c.qcom,camera"), //FFC
	CLK_LOOKUP_OF("cam_clk", camss_gp0_clk, "6c.qcom,camera"),
#endif
};
