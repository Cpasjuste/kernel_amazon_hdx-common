...
#if !defined(CONFIG_ARCH_APQ8084_SATURN)
...
static struct gpiomux_setting max97236_int_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_6MA,
	.pull = GPIOMUX_PULL_UP,
};

static struct gpiomux_setting hall_sus_cfg = {
  .func = GPIOMUX_FUNC_GPIO,
  .drv  = GPIOMUX_DRV_2MA,
  .pull = GPIOMUX_PULL_NONE,
};

static struct gpiomux_setting hall_act_cfg = {
  .func = GPIOMUX_FUNC_GPIO,
  .drv  = GPIOMUX_DRV_2MA,
  .pull = GPIOMUX_PULL_NONE,
  .dir  = GPIOMUX_IN
...
static struct msm_gpiomux_config msm_ah1903_configs[] __initdata = {
  {
    .gpio      = 123,/* HALL_SEN1 Interrupt */
    .settings = {
      [GPIOMUX_ACTIVE] = &hall_act_cfg,
      [GPIOMUX_SUSPENDED] = &hall_sus_cfg,
    },
  },
  {
    .gpio      = 141,/* HALL_SEN3 Interrupt */
    .settings = {
      [GPIOMUX_ACTIVE] = &hall_act_cfg,
      [GPIOMUX_SUSPENDED] = &hall_sus_cfg,
    },
...
#if defined(CONFIG_ARCH_APQ8084_LOKI) || defined(CONFIG_ARCH_APQ8084_SATURN)
static struct gpiomux_setting synaptics_gpio_id_act_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_IN,
...
static struct gpiomux_setting synaptics_gpio_id_sus_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir = GPIOMUX_IN,
...
static struct msm_gpiomux_config msm_synaptics_configs[] __initdata = {
...
#if defined(CONFIG_ARCH_APQ8084_LOKI) || defined(CONFIG_ARCH_APQ8084_SATURN)
	{
		.gpio = 124,
		.settings = {
			[GPIOMUX_ACTIVE] = &synaptics_gpio_id_act_cfg,
			[GPIOMUX_SUSPENDED] = &synaptics_gpio_id_sus_cfg,
		},
	},
	{
		.gpio = 125,
...
#if defined(CONFIG_ARCH_APQ8084_LOKI) || defined(CONFIG_ARCH_APQ8084_SATURN)
static struct gpiomux_setting smb349_chrg_susp_act_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_OUT_HIGH,
};
static struct gpiomux_setting smb349_chrg_susp_sus_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_DOWN,
};

static struct msm_gpiomux_config msm_smb349_configs[] __initdata = {
	{
		.gpio = 83,
		.settings = {
			[GPIOMUX_ACTIVE] = &smb349_chrg_susp_act_cfg,
			[GPIOMUX_SUSPENDED] = &smb349_chrg_susp_sus_cfg,
		},
	},
};

static struct gpiomux_setting gpio_slimport_pd_config = {
	.pull = GPIOMUX_PULL_DOWN,
	.drv = GPIOMUX_DRV_8MA,
	.func = GPIOMUX_FUNC_GPIO,
};

static struct gpiomux_setting gpio_slimport_config = {
	.pull = GPIOMUX_PULL_UP,
	.drv = GPIOMUX_DRV_8MA,
	.func = GPIOMUX_FUNC_GPIO,
};
...
static struct msm_gpiomux_config slimport_configs[] __initdata = {
	{
		.gpio = 3,
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_slimport_pd_config,
		},
	},
	{
		.gpio = 64,
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_slimport_config,
		},
	},
	{
		.gpio = 115,
...
static struct msm_gpiomux_config msm_max97236_configs[] __initdata = {
	{
		.gpio = 102,
		.settings = {
			[GPIOMUX_ACTIVE] = &max97236_int_cfg,
		},
	},
};
#endif
...
#if defined(CONFIG_ARCH_APQ8084_LOKI) || defined(CONFIG_ARCH_APQ8084_SATURN)
static struct gpiomux_setting ernie_resume_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
...
static struct gpiomux_setting ernie_wake_cfg = {
        .func = GPIOMUX_FUNC_GPIO,
        .drv = GPIOMUX_DRV_8MA,
	.pull = GPIOMUX_PULL_DOWN,
	.dir  = GPIOMUX_IN
...
static struct msm_gpiomux_config ernie_configs[] = {
	{
		.gpio      = 130,		/* HMI GPIO */
		.settings = {
			[GPIOMUX_SUSPENDED] = &ernie_resume_cfg,
		},
	},
	{
                .gpio      = 111,               /* MHI GPIO */
                .settings = {
                        [GPIOMUX_SUSPENDED] = &ernie_wake_cfg,
                },
        },
...
#if defined(CONFIG_ARCH_APQ8084_LOKI) || defined(CONFIG_ARCH_APQ8084_SATURN)
static struct msm_gpiomux_config apq8084_pri_mi2s_configs[] __initdata = {
	{
		.gpio = 76,
		.settings = {
			[GPIOMUX_SUSPENDED] = &auxpcm_sus_cfg,
...
static struct msm_gpiomux_config msm_qca1530_saturn_configs[] __initdata = {
	{
		.gpio = 128,    /* qca1530 reset */
		.settings = {
			[GPIOMUX_SUSPENDED] = &gpio_qca1530_config,
...
#if defined(CONFIG_ARCH_APQ8084_LOKI) || defined(CONFIG_ARCH_APQ8084_SATURN)
	msm_gpiomux_install(msm_max97236_configs,
					ARRAY_SIZE(msm_max97236_configs));
	msm_gpiomux_install(msm_smb349_configs,
					ARRAY_SIZE(msm_smb349_configs));
	/* add for intergating hall sensor driver */
	msm_gpiomux_install(msm_ah1903_configs,
					ARRAY_SIZE(msm_ah1903_configs));
	msm_gpiomux_install(slimport_configs, ARRAY_SIZE(slimport_configs));
#endif

	if (of_board_is_loki() || of_board_is_saturn()) {
		msm_gpiomux_install(msm_blsp2_uart5_configs,
				ARRAY_SIZE(msm_blsp2_uart5_configs));
		msm_gpiomux_install(msm_qca1530_saturn_configs,
				ARRAY_SIZE(msm_qca1530_saturn_configs));
	} else if (of_board_is_liquid() || of_board_is_sbc()) {
		msm_gpiomux_install(msm_blsp2_uart5_configs,
				ARRAY_SIZE(msm_blsp2_uart5_configs));
...
#if defined(CONFIG_ARCH_APQ8084_LOKI) || defined(CONFIG_ARCH_APQ8084_SATURN)
	msm_gpiomux_install(apq8084_pri_mi2s_configs,
			ARRAY_SIZE(apq8084_pri_mi2s_configs));
...
#endif
#if defined(CONFIG_ARCH_APQ8084_LOKI) || defined(CONFIG_ARCH_APQ8084_SATURN)
	msm_gpiomux_install(ernie_configs,
			ARRAY_SIZE(ernie_configs));
#endif
