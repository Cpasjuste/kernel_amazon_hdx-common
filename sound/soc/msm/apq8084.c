...
static int apq8084_mi2s_ref_get(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
	pr_info("%s: current ref : %d\n", __func__, atomic_read(&pri_mi2s_clk.mi2s_rsc_ref));
	ucontrol->value.integer.value[0] = atomic_read(&pri_mi2s_clk.mi2s_rsc_ref);
	return 0;
}
static int apq8084_mi2s_ref_put(struct snd_kcontrol *kcontrol,
				   struct snd_ctl_elem_value *ucontrol)
{
	int mi2s_ref_to_set;

	mi2s_ref_to_set = ucontrol->value.integer.value[0];
	pr_info("%s: ref to set : %d, current ref : %d\n", __func__, mi2s_ref_to_set, atomic_read(&pri_mi2s_clk.mi2s_rsc_ref));
	atomic_set(&pri_mi2s_clk.mi2s_rsc_ref, mi2s_ref_to_set);
...
#if defined(CONFIG_ARCH_APQ8084_LOKI) || defined(CONFIG_ARCH_APQ8084_SATURN)
	SOC_SINGLE_EXT("MI2S_Ref", 0, 0, 1, 0,
		apq8084_mi2s_ref_get, apq8084_mi2s_ref_put),
#endif
...
#define GPIO_PRI_MI2S_MCLK   76
#define GPIO_PRI_MI2S_SCK    77
#define GPIO_PRI_MI2S_WS     78
#define GPIO_PRI_MI2S_DATA0  79
#define GPIO_PRI_MI2S_DATA1  80

#define MI2S_LPASS_CLK_ENABLE
//#define USE_ORG_I2S_CONFIG
...
static struct request_gpio pri_mi2s_gpio[] = {
	...
	{
		.gpio_no = GPIO_PRI_MI2S_MCLK,
		.gpio_name = "PRI_MI2S_MCLK",
	},

	{
		.gpio_no = GPIO_PRI_MI2S_SCK,
		.gpio_name = "PRI_MI2S_SCK",
	},
	{
		.gpio_no = GPIO_PRI_MI2S_WS,
		.gpio_name = "PRI_MI2S_WS",
	},

	{
		.gpio_no = GPIO_PRI_MI2S_DATA0,
		.gpio_name = "PRI_MI2S_DATA0",
	},
	{
		.gpio_no = GPIO_PRI_MI2S_DATA1,
		.gpio_name = "PRI_MI2S_DATA1",
	},
		...
		struct snd_pcm_hw_params *params)
{
	...
	{
		pr_debug("%s: acquired mi2s resources\n", __func__);

		apq8084_configure_pri_mi2s_gpio();

#ifdef USE_ORG_I2S_CONFIG
		...
		if(substream->stream==0)
			ret = afe_set_lpass_clock(AFE_PORT_ID_PRIMARY_MI2S_RX, &lpass_mi2s_enable);
        ...
        case 4: /* Four channel TDM mode */
			...
			SND_SOC_DAIFMT_CBS_CFS;
                break;
        default:
		pr_info("%s: params_channels: %d", __func__, params_channels(params));
                return -EINVAL;
        }
...
static void apq8084_mi2s_shutdown(struct snd_pcm_substream *substream)
{
	...
	if(atomic_read(&pri_mi2s_clk.mi2s_rsc_ref) < 0) {
...
//	.startup = apq8084_mi2s_startup,
	.hw_params = apq8084_mi2s_startup,
...
static struct snd_soc_dai_link apq8084_common_dai_links[] = {
	...
	},
	{
		...
		.cpu_dai_name = "PRI_MI2S_HOSTLESS",
		.platform_name = "msm-pcm-hostless",
		.dynamic = 1,
		.trigger = {SND_SOC_DPCM_TRIGGER_POST,
			    SND_SOC_DPCM_TRIGGER_POST},
...
static struct snd_soc_dai_link apq8084_taiko_be_dai_links[] = {
...

	{
		...
		.platform_name = "msm-pcm-routing",
		.codec_name 	= "max98925.2-0031",//"msm-stub-codec.1",
		.codec_dai_name = "max98925-aif1",//"msm-stub-tx",
		.no_pcm = 1,
		.be_id = MSM_BACKEND_DAI_PRI_MI2S_RX, // MSM_BACKEND_DAI_SECONDARY_MI2S_RX,
	...
	},
	{
		...
		.codec_dai_name = "max98925-aif1",//"msm-stub-tx",
		.no_pcm = 1,
		.be_id =  MSM_BACKEND_DAI_PRI_MI2S_TX, // MSM_BACKEND_DAI_SECONDARY_MI2S_TX,
		.be_hw_params_fixup = msm_be_mi2s_hw_params_fixup,
		.ops = &apq8084_mi2s_be_ops,
		.dynamic = 1,
	},
...
#ifdef CONFIG_SND_SOC_MAX97236
	{
		.name = LPASS_BE_MAX97236_RX,
		.stream_name = "HiFiPlayback",
		.cpu_dai_name = "msm-dai-q6-dev.16384",
		.platform_name = "msm-pcm-routing",
		.codec_dai_name = "HiFi",
		.codec_name = "max97236.0-0040",
		.be_id = MSM_BACKEND_DAI_MAX_97236_RX,
		.ops = NULL,
		.init = NULL,
	},
	{
		.name = LPASS_BE_MAX97236_TX,
		.stream_name = "HiFiCapture",
		.cpu_dai_name = "msm-dai-q6-dev.16385",
		.platform_name = "msm-pcm-routing",
		.codec_dai_name = "HiFi",
		.codec_name = "max97236.0-0040",
		.be_id = MSM_BACKEND_DAI_MAX_97236_TX,
		.ops = NULL,
		.init = NULL,
	},
#endif
...
struct snd_soc_card snd_soc_card_apq8084 = {
...
static int msm_mi2s_get_pinctrl(struct platform_device *pdev)
{
	...
	if (IS_ERR_OR_NULL(pinctrl)) {
		pr_debug("%s: Unable to get pinctrl handle\n", __func__);
		return -EINVAL;
	}
