...
static const char *dsm_filter_text[] = { "Disable", "Enable", "GetPrms",
                                         ...
                                         "RxInit", "TxInit", "GetParam",
					 "SetParam", "DumpParam", "SetFromFile",
					 "DumpToTxt", "SetFromTxt"};
...
struct msm_pcm_routing_bdai_data msm_bedais[MSM_BACKEND_DAI_MAX] = {
	...
	{ SLIMBUS_0_RX, 0, 0, 0, 0, 0, 0, 0, LPASS_BE_MAX97236_RX},
	{ SLIMBUS_0_TX, 0, 0, 0, 0, 0, 0, 0, LPASS_BE_MAX97236_TX},
};
...
static const struct snd_kcontrol_new primary_mi2s_rx_port_mixer_controls[] = {
	...
	msm_routing_put_port_mixer),
// ES10 QCOM_DROP Picked LAB126 code
#if defined(CONFIG_ARCH_APQ8084_LOKI) || defined(CONFIG_ARCH_APQ8084_SATURN)
...
static const struct snd_soc_dapm_widget msm_qdsp6_widgets[] = {
	...
	SND_SOC_DAPM_AIF_OUT("PRI_MI2S_UL_HL",
		"PRI_MI2S_HOSTLESS Capture",
		0, 0, 0, 0),
	SND_SOC_DAPM_AIF_OUT("PRI_MI2S_DL_HL",
		"PRI_MI2S_HOSTLESS Playback",
		0, 0, 0, 0),
...
#if defined(CONFIG_ARCH_APQ8084_LOKI) || defined(CONFIG_ARCH_APQ8084_SATURN)
	{"MI2S_UL_HL", NULL, "PRI_MI2S_TX"},
	{"PRI_MI2S_RX", NULL, "MI2S_DL_HL"},
#else
